                ...
                .setPositiveButton("Send", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (receiverUsername.isEmpty()) {
                            ...
                            EncryptionHelper.getInstance(AudioPlayerActivity.this).saveReceiverUsername(receiverUsername);
                ...
                .setNeutralButton("Copy PIN", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (clipboard != null) {
                            ...
                            clipboard.setPrimaryClip(clip);
                            Toast.makeText(AudioPlayerActivity.this, "Secret PIN copied to clipboard!", Toast.LENGTH_SHORT).show();
                        }
